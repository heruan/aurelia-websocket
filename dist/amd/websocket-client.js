define(["exports", "aurelia-dependency-injection", "aurelia-event-aggregator", "aurelia-http-client", "aurelia-json", "./join-message", "./leave-message"], function (exports, _aureliaDependencyInjection, _aureliaEventAggregator, _aureliaHttpClient, _aureliaJson, _joinMessage, _leaveMessage) {
    "use strict";
